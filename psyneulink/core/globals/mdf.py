...
Any PsyNeuLink `Composition` or `Component` can be exported to MDF format using its `to_mdf` method or
...
class MDFSerializable:
    ...
    def json_summary(self):
        return self.to_mdf().to_json()

    @property
    def yaml_summary(self):
        return self.to_mdf().to_yaml()
...
def get_mdf_model(*compositions, simple_edge_format=True):
    ...
    for c in compositions:
        ...
        model.graphs.append(c.to_mdf(simple_edge_format=simple_edge_format))
