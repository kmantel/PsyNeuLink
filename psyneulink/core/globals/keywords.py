...
__all__ = [
    ...
    'MODEL_SPEC_ID_RECEIVER_MECH', 'MODEL_SPEC_ID_RECEIVER_PORT', 'MODEL_SPEC_ID_GENERATING_APP', 'MODEL_SPEC_ID_FORMAT',
    'MODEL_SPEC_ID_VERSION', 'MODEL_SPEC_ID_PARAMETER_INITIAL_VALUE', 'MODEL_SPEC_ID_PARAMETER_SOURCE',
