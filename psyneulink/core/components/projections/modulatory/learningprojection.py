...
components <LearningMechanism_Learning_Configurations>`, can be displayed using the Composition's `show_graph
<ShowGraph.show_graph>` method with its **show_learning** argument assigned as `True`.
