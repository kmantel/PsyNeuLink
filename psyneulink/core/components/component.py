...
from psyneulink.core.globals.utilities import ContentAddressableList, ReadOnlyOrderedDict, convert_all_elements_to_np_array, convert_to_np_array, get_deepcopy_with_shared, is_instance_or_subclass, is_matrix, iscompatible, kwCompatibilityLength, parse_valid_identifier, prune_unused_args, unproxy_weakproxy
    ...
    def _dict_summary(self):
        ...
        def parse_parameter_value(value):
            if isinstance(value, (list, tuple)):
                ...
                value = '{0}.{1}.{2}'.format(
                    parse_valid_identifier(value.owner.name),
                    state_port_name,
                    value.name
                )
