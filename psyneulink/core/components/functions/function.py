...
from psyneulink.core.globals.utilities import (
    convert_all_elements_to_np_array, convert_to_np_array, extract_0d_array_item, get_global_seed, is_instance_or_subclass, object_has_single_value, parameter_spec, parse_valid_identifier, safe_len,
...
def _seed_setter(value, owning_component, context):
    try:
        value = extract_0d_array_item(value)
    except ValueError:
        pass
