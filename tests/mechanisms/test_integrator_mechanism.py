...
class TestReset:
    def test_FitzHughNagumo_valid(self):
        ...
        np.testing.assert_allclose([[0.05127053]], I.value[0])
        np.testing.assert_allclose([[0.00279552]], I.value[1])
        np.testing.assert_allclose([[0.05]], I.value[2])

        I.function.reset(0.01, 0.02, 0.03)

        np.testing.assert_allclose(0.01, I.function.value[0])
        np.testing.assert_allclose(0.02, I.function.value[1])
        np.testing.assert_allclose(0.03, I.function.value[2])

        np.testing.assert_allclose([[0.05127053]], I.value[0])
        np.testing.assert_allclose([[0.00279552]], I.value[1])
        np.testing.assert_allclose([[0.05]], I.value[2])

        np.testing.assert_allclose([[0.05127053]], I.output_ports[0].value)

        I.execute(1.0)

        np.testing.assert_allclose([[0.06075727]], I.value[0])
        np.testing.assert_allclose([[0.02277156]], I.value[1])
        np.testing.assert_allclose([[0.08]], I.value[2])

        np.testing.assert_allclose([[0.06075727]], I.output_ports[0].value)

        # I.reset(new_previous_v=0.01, new_previous_w=0.02, new_previous_time=0.03)
        I.reset(0.01, 0.02, 0.03)

        np.testing.assert_allclose(0.01, I.value[0])
        np.testing.assert_allclose(0.02, I.value[1])
        np.testing.assert_allclose(0.03, I.value[2])

        np.testing.assert_allclose(0.01, I.output_ports[0].value)
        # np.testing.assert_allclose(0.01, I.output_port.value[0])
        # np.testing.assert_allclose(0.02, I.output_port.value[1])
        # np.testing.assert_allclose(0.03, I.output_port.value[2])
...
class TestIntegratorFunctions:
    ...
    def test_integrator_multiple_input(self, benchmark, mech_mode):
        ...
        np.testing.assert_allclose(val, [[3]])
