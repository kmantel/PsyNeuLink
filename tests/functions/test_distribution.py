...
test_data = [
    ...
    pytest.param(Functions.DriftDiffusionAnalytical, np.full(5, test_var), {}, None, None,
                 ...
                 id="DriftDiffusionAnalytical-Array-DefaultParameters"),
    pytest.param(Functions.DriftDiffusionAnalytical, np.full(5, test_var),
                 {"drift_rate": [RAND1] * 5, "threshold": RAND2, "starting_value": RAND3,
                  "non_decision_time": RAND4, "noise": RAND5}, None, None,
                 tuple((dda_expected_random[i],) * 5 for i in range(len(dda_expected_random))),
                 id="DriftDiffusionAnalytical-Array-RandomDriftRate"),
